  ...
  return (
    <div className="relative min-h-screen overflow-hidden" ref={emblaRef}>
      ...
      <div className="absolute top-24 left-[106px] z-20">
        <h1 className="inline-block px-3 py-1 border-2 border-foreground/90 text-foreground bg-background/10 rounded-lg text-3xl font-light tracking-[0.2em] uppercase transition-all duration-300 hover:bg-foreground/10 cursor-pointer">
          COCKTAILS
        </h1>
      </div>
