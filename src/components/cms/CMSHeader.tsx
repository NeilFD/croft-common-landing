    ...
    <header className="flex items-center justify-between h-16 px-3 sm:px-6 border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 relative z-50">
      <div className="flex items-center gap-2 sm:gap-4 min-w-0 flex-1">
        ...
        <div className="hidden lg:flex flex-col">
          <h2 className="text-lg font-bold tracking-wide text-foreground">CRAZY BEAR</h2>
        </div>
        ...
        <div className="min-w-0">
          ...
          <p className="hidden sm:block text-sm text-muted-foreground">Country and Town site content</p>
        </div>
      </div>
