  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center z-30 pointer-events-none px-4 py-8">
      <div className="max-w-3xl w-full mx-auto pointer-events-auto">
        <div className="bg-background/80 backdrop-blur-md border border-charcoal/20 p-6 md:p-10 lg:p-16 rounded-lg shadow-2xl relative min-h-[400px] md:min-h-[500px] flex flex-col justify-center">
