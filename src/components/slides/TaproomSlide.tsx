...
export const TaproomSlide: React.FC<TaproomSlideProps> = ({
  ...
  return (
    <div className="relative w-full h-screen flex flex-col md:flex-row overflow-hidden">
      ...
      <div className="w-full md:w-1/2 h-1/2 md:h-full bg-[hsl(var(--accent-pink))] text-white pt-40 pb-24 md:p-8 lg:p-12 px-4 md:px-8 lg:px-12 flex flex-col relative">
