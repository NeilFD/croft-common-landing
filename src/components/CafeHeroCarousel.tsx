  ...
  return (
    <div className="relative min-h-screen overflow-hidden" ref={emblaRef}>
      ...
      <div className="absolute top-28 left-8 z-20">
        <h1 className="font-brutalist text-4xl md:text-6xl text-background">
          CAFÉ
        </h1>
      </div>

      {/* Fixed watermark overlay - positioned over coffee cup */}
      <div className="absolute inset-0 flex items-center justify-center pointer-events-none z-10" style={{ transform: 'translate(8rem, 4rem)' }}>
        <img 
          src="/lovable-uploads/a2ee3fd5-4eb3-4a7e-8433-c4bb065295f4.png" 
          alt="Croft Common Watermark" 
          className="w-[30rem] h-[30rem] opacity-60 object-contain transition-all duration-1000"
          style={{ 
