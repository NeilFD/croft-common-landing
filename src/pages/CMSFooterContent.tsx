...
import FooterContentEditor from '@/components/cms/FooterContentEditor';

const CMSFooterContent = () => {
    ...
    try {
      ...
      if (result.success) {
        ...
        toast({
          ...
          description: "Your footer content has been published to the live site.",
        });
      } else {
...
export default CMSFooterContent;