        ...
        days.push(
          <div
            ...
            className={`min-h-[80px] md:min-h-[120px] border border-border/30 p-1 md:p-2 ${
              !isSameMonth(day, monthStart) ? 'text-muted-foreground bg-muted/20' : 'bg-background/80 backdrop-blur-sm'
            }`}
          >
              ...
              {dayEvents.slice(0, 4).map((event, index) => {
                ...
                return (
                  <button
                    ...
                    title={event.title}
                  >
                    <span className="text-[4px] xs:text-[5px] sm:text-[6px] md:text-[7px] font-bold text-white capitalize leading-none text-center whitespace-nowrap">
                      {event.category}
                    </span>
                  </button>
                );
              ...
              {dayEvents.slice(0, 4).map((event, index) => {
                ...
                return (
                  <button
                    ...
                    title={event.title}
                  >
                    <span className="text-[8px] md:text-[9px] font-bold text-white capitalize leading-none text-center whitespace-nowrap">
                      {event.category}
                    </span>
                  </button>
                );
