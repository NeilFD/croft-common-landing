              ...
              <TabsContent value="halls" className="space-y-0">
                ...
                <div className="max-w-4xl space-y-12 ml-4 md:ml-8 lg:ml-12">
                  {oneKitchenMenuData.slice(28).map((section, sectionIndex) => {
                    // Major section breaks for better visual separation
                    const isMajorSectionBreak = (
                      section.title === "Plated Three Course" || 
                      section.title === "Feast Style — Served Down The Table"
                    );
                      ...
                      <div key={section.title}>
                        {isMajorSectionBreak && (
                          <div className="flex justify-center py-8">
                            <div className="w-48 h-0.5 bg-accent-pink"></div>
                          </div>
                        )}
