      ...
      <SidebarContent>
        {navigationItems.map((section) => (
          <SidebarGroup key={section.title}>
            {section.items ? (
              <>
                <SidebarGroupLabel className="px-3 py-2 mx-2 mb-1 rounded-lg border-2 border-pink-500/20 text-foreground font-semibold text-sm tracking-wide uppercase hover:border-pink-500/40 transition-colors text-left">
