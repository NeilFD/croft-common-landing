...
export const beerMenu: MenuSection[] = [
  {
    ...
    items: [
      { name: "Left Handed Giant - Sky Above (Pale Ale)", description: "4.5%" },
      { name: "Left Handed Giant - Dream House (IPA)", description: "6.2%" },
      { name: "Left Handed Giant - West Coast Pils", description: "5.0%" },
      { name: "Wiper & True - Kaleidoscope (Pale Ale)", description: "4.2%" },
      { name: "Wiper & True - Milkshake Porter", description: "5.3%" },
      { name: "Lost & Grounded - Keller Pils", description: "4.8%" },
      { name: "Lost & Grounded - Apophenia (Tripel)", description: "8.8%" },
      { name: "Bristol Beer Factory - Southville Hop IPA", description: "6.5%" },
      { name: "Bristol Beer Factory - Milk Stout", description: "4.5%" },
      { name: "LHG - Infinite Days IPA", description: "6.5%" },
      { name: "LHG - Ready, Set, Go!", description: "6.5%" },
      { name: "LHG - Twin Cities (GF Pale Ale)", description: "5.5%" },
