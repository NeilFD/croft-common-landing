...
export const CMS_PAGES: CmsPageEntry[] = [
  ...
  { slug: 'pub', route: '/pub', title: 'The Pub', description: 'Top-level pub landing (Country, Stadhampton)', group: 'Pub', icon: UtensilsCrossed, component: PubHome, property: 'country',
  ...
  { slug: 'pub-food', route: '/pub/food', title: 'Pub Food', description: 'Food at The Pub', group: 'Pub', icon: UtensilsCrossed, component: PubFood, parentSlug: 'pub', property: 'country',
  ...
  { slug: 'pub-drink', route: '/pub/drink', title: 'Pub Drink', description: 'The bar at The Pub', group: 'Pub', icon: Wine, component: PubDrink, parentSlug: 'pub', property: 'country',
  ...
  { slug: 'pub-snacks', route: '/pub/snacks', title: 'Bar Snacks', description: 'Pub snacks menu', group: 'Pub', icon: UtensilsCrossed, component: PubSnacks, parentSlug: 'pub', property: 'country',
