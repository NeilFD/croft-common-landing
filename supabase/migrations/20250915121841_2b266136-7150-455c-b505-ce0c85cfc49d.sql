...
((SELECT id FROM public.cms_menu_sections WHERE page = 'kitchens-halls' AND section_name = 'Starters'), 'Roast Beetroot, Whipped Goat\'s Cheese, Walnuts', '', '£9', 6, true),
...
-- Insert The Feast
INSERT INTO public.cms_menu_items (section_id, item_name, description, price, sort_order, published) VALUES
((SELECT id FROM public.cms_menu_sections WHERE page = 'kitchens-halls' AND section_name = 'The Feast — £70pp'), 'Starters', 'Octopus & Aioli, Lamb Chops, Roast Beetroot & Goat\'s Cheese, Charred Cauliflower Salad', '', 1, true),
...
INSERT INTO public.cms_menu_items (section_id, item_name, description, price, sort_order, published) VALUES
((SELECT id FROM public.cms_menu_sections WHERE page = 'kitchens-halls' AND section_name = 'Bespoke Events'), 'Bespoke curated party and event food available', 'We\'re here to deliver, we love a challenge.', '', 1, true);