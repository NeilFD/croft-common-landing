...
export const MagicLinkEmail = ({
  ...
  <Html lang="en" dir="ltr">
    <Head />
    <Preview>Your key to the den</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Your key to the den</Heading>

        <Text style={text}>
          One tap and you're back inside. This link is only good for you,
        ...
        <Hr style={rule} />
        <Text style={footer}>
          Didn't ask for this? Ignore the email. Nobody gets in without the link.
        </Text>
